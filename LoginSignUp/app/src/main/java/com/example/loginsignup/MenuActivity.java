...
public class MenuActivity extends Activity {
    ...
    protected void kiem_tra_checkbox() {
        // Khởi tạo checkbox
        CheckBox chkMon1 = (CheckBox) findViewById(R.id.mon1_321);
        CheckBox chkMon2 = (CheckBox) findViewById(R.id.mon2_321);
        CheckBox chkMon3 = (CheckBox) findViewById(R.id.mon3_321);
        CheckBox chkMon4 = (CheckBox) findViewById(R.id.mon4_321);
        CheckBox chkMon5 = (CheckBox) findViewById(R.id.mon5_321);
        CheckBox chkMon6 = (CheckBox) findViewById(R.id.mon6_321);
        CheckBox chkMon7 = (CheckBox) findViewById(R.id.mon7_321);
        CheckBox chkMon8 = (CheckBox) findViewById(R.id.mon8_321);

        EditText edt1 = (EditText) findViewById(R.id.mon1_so_phan_321);
        EditText edt2 = (EditText) findViewById(R.id.mon2_so_phan_321);
        EditText edt3 = (EditText) findViewById(R.id.mon3_so_phan_321);
        EditText edt4 = (EditText) findViewById(R.id.mon4_so_phan_321);
        EditText edt5 = (EditText) findViewById(R.id.mon5_so_phan_321);
        EditText edt6 = (EditText) findViewById(R.id.mon6_so_phan_321);
        EditText edt7 = (EditText) findViewById(R.id.mon7_so_phan_321);
        EditText edt8 = (EditText) findViewById(R.id.mon8_so_phan_321);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Khởi tạo edit text
        final EditText edt1 = (EditText) findViewById(R.id.mon1_so_phan_321);
        final EditText edt2 = (EditText) findViewById(R.id.mon2_so_phan_321);
        final EditText edt3 = (EditText) findViewById(R.id.mon3_so_phan_321);
        final EditText edt4 = (EditText) findViewById(R.id.mon4_so_phan_321);
        final EditText edt5 = (EditText) findViewById(R.id.mon5_so_phan_321);
        final EditText edt6 = (EditText) findViewById(R.id.mon6_so_phan_321);
        final EditText edt7 = (EditText) findViewById(R.id.mon7_so_phan_321);
        final EditText edt8 = (EditText) findViewById(R.id.mon8_so_phan_321);
    ...
    public void Ham_xac_nhan_dat_mon(View v) {
        ...
        // Lấy số bàn
        EditText nhap_so_ban = (EditText) findViewById(R.id.so_ban_nhap_321);
