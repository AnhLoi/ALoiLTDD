...
public class ChangeMenuActivity extends Activity {
    ...
    protected void kiem_tra_checkbox() {
        // Khởi tạo checkbox
        CheckBox chkMon1 = (CheckBox) findViewById(R.id.mon1_2_321);
        CheckBox chkMon2 = (CheckBox) findViewById(R.id.mon2_2_321);
        CheckBox chkMon3 = (CheckBox) findViewById(R.id.mon3_2_321);
        CheckBox chkMon4 = (CheckBox) findViewById(R.id.mon4_2_321);
        CheckBox chkMon5 = (CheckBox) findViewById(R.id.mon5_2_321);
        CheckBox chkMon6 = (CheckBox) findViewById(R.id.mon6_2_321);
        CheckBox chkMon7 = (CheckBox) findViewById(R.id.mon7_2_321);
        CheckBox chkMon8 = (CheckBox) findViewById(R.id.mon8_2_321);

        EditText edt1 = (EditText) findViewById(R.id.mon1_so_phan_2_321);
        EditText edt2 = (EditText) findViewById(R.id.mon2_so_phan_2_321);
        EditText edt3 = (EditText) findViewById(R.id.mon3_so_phan_2_321);
        EditText edt4 = (EditText) findViewById(R.id.mon4_so_phan_2_321);
        EditText edt5 = (EditText) findViewById(R.id.mon5_so_phan_2_321);
        EditText edt6 = (EditText) findViewById(R.id.mon6_so_phan_2_321);
        EditText edt7 = (EditText) findViewById(R.id.mon7_so_phan_2_321);
        EditText edt8 = (EditText) findViewById(R.id.mon8_so_phan_2_321);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button changeMenu = (Button) findViewById(R.id.btn_change_menu_321);
