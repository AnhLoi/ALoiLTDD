...
public class Register_form extends AppCompatActivity implements View.OnClickListener {
    ...
    private void connectView() {
        ...
        editLoca = (EditText) findViewById(R.id.edit_loca_321);
    ...
    private void register() {
        ...
        String location = editLoca.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(location)) {
            editLoca.requestFocus();
            editLoca.setError(context.getResources().getString(R.string.error_field_required));
            error = true;
        }
        // password empty
        ...
        if (!error) {
            ...
            // send data
            intent.putExtra(Signin_form.KEY_USER_FROM_REGISTER, userName);
    ...
    private void goBack() {
        Intent intent = new Intent(context, Signin_form.class);
