...
public class BillActivity extends Activity {
    ...
    String tong_cong_321;
    int code;
    InputStream is = null;
    String result = null;
    String line = null;
    String so_ban_bill_321;
    private ProgressDialog pDialog;
    List<String> so_ban_da_co_321 = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        so_ban_da_co_321 = packageFromCaller.getStringArrayList("so_ban_da_co");

        final Button btnGet_Bill = (Button) findViewById(R.id.nhanbill_321);
        final EditText edtSo_Ban_Bill = (EditText) findViewById(R.id.so_ban_bill_321);
        ...
        btnGet_Bill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                so_ban_bill_321 = edtSo_Ban_Bill.getText().toString();
                new GetBill().execute();
            }
        });
        ...
        edtSo_Ban_Bill.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before,
                                      int count) {
                final String[] so_ban_da_co_spl = new String[so_ban_da_co_321.size()];
                so_ban_da_co_321.toArray(so_ban_da_co_spl);
    ...
    class GetBill extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            //    List<NameValuePair> params = new ArrayList<NameValuePair>();
             //   params.add(new BasicNameValuePair("so_ban_bill", so_ban_bill_321));
        ...
        //    }
            ...
            try {
                ...
                tong_cong_321 = (json_data.getString("tong_cong"));
                    ...
                    public void run() {
                        ...
                        alertDialog
                                .setMessage("Tổng số tiền cần thanh toán: \r\n"
                                        + tong_cong_format(tong_cong_321)
                                        + " 000đ \r\n"
